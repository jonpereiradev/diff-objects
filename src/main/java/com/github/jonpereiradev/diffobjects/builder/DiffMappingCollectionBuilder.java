 ...
 * @since 1.0
 */
public interface DiffMappingCollectionBuilder<T> {
     ...
     */
    DiffMappingCollectionBuilder<T> mapping(String field);
     ...
     * @return the instance of this mapping.
     */
    <F> DiffMappingCollectionBuilder<T> mapping(String field, Class<F> fieldClass, DiffComparator<F> comparator);

    /**
     * @return returns to the mapping object to continue the creation of the mapping.
     */
    DiffMappingBuilder<T> mappingBuilder();
